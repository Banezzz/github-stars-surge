...
DOC_PATHS = [
    ...
    "/api/v1/repos?limit=200",
    "/api/v1/repos?min_stars=5000&sort=peak_stars",
    "/api/v1/repos?fields=card&limit=1000",
    "/api/v1/repos?language=TypeScript&min_stars=1000&limit=100",
    "/api/v1/repos?language=Python&min_stars=1000&limit=100",
    ...
    "/api/v1/search?q=agent+harness&limit=200",
